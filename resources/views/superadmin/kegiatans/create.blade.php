...
<div class="table-container p-4" style="max-width: 600px;">
    <form method="POST" action="{{ route('superadmin.kegiatans.store') }}">
        @csrf
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="nama_kegiatan" class="form-control @error('nama_kegiatan') is-invalid @enderror" value="{{ old('nama_kegiatan') }}" required placeholder="Masukkan nama kegiatan">
