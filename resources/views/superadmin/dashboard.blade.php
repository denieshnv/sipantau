...
<div class="table-container p-3 mb-4">
    <form method="GET" action="{{ route('superadmin.dashboard') }}" class="row g-3 align-items-end">
        <div class="col-auto">
            ...
            <select name="bulan" class="form-select" id="filter-bulan" style="min-width: 200px;">
...
<div class="row g-3 mb-4">
    ...
    <div class="col-md-3">
        <div class="stat-card">
            ...
            <div class="stat-label">Total Admin / PPTK</div>
        </div>
    </div>
</div>
...
<div class="table-container p-5 text-center">
    ...
    @if(!empty($bulan) || !empty($status))
        ...
        <a href="{{ route('superadmin.dashboard') }}" class="btn btn-outline-primary btn-sm mt-2">
            <i class="bi bi-arrow-counterclockwise"></i> Reset Filter
        </a>
    @else
        <p class="text-muted mt-2">Belum ada data program. Silakan tambahkan melalui menu Data Master.</p>
    @endif
</div>
@endif
